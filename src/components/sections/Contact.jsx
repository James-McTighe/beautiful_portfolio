          ...
          <form className="space-y-6">
            ...
            <div className="relative">
              <input
                ...
                name="name"
                required
                className="w-full bg-white/5 border border-white/30 rounded px-4 py-3 text-white transition 
            ...
            <button
              ...
              transition duration-300 ease-in-out relative overflow-hidden hover:bg-green-700 
              hover:-translate-y-0.5
              hover:shadow-[0_0_15px_rgba(59, 130,246)]"
            >
              Send Message!
            </button>
          </form>
